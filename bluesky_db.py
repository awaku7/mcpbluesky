...
class BlueskyDB:
    """Blueskyの投稿データを保存・検索するためのSQLiteラッパー"""
    
    def __init__(self, db_path: str = "bluesky_posts.db"):
    ...
    def init_db(self):
        ...
        # 全文検索用インデックス（FTS5が使える場合）
        # 簡易的な検索ならLIKEで十分だが、件数が増えるならFTS推奨
        # ここではシンプルにLIKE検索を想定し、インデックスはuriのみ
